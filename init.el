...
(custom-set-variables
 ...
 '(package-selected-packages
   '(expand-region projectile helm-lsp which-key clj-refactor cider-hydra company cider clojure-mode lsp-treemacs lsp-ivy lsp-ui lsp-mode setup use-package)))
(custom-set-faces
